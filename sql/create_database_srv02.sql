...
CREATE USER 'loa_user'@'sig-srv-02.subnet.vcn.oraclevcn.com' IDENTIFIED BY 'password';
...
--
GRANT CREATE, ALTER, INDEX, DROP, INSERT, UPDATE, DELETE, REFERENCES, SELECT ON loa_db.* TO 'loa_user'@'sig-srv-02.subnet.vcn.oraclevcn.com';
